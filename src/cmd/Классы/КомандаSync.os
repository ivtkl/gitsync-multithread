...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("n threads-number", "", "Количество потоков выполнения (по умолчанию: 1)")
					.ТЧисло()
					.ВОкружении("GITSYNC_THREADS_NUMBER")
					.ПоУмолчанию(1);					
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	КоличествоПотоков		= Команда.ЗначениеОпции("threads-number");
